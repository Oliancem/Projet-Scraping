...
# On nettoye la colonne 'Job Title' en supprimant les informations de salaire et les balises HTML
...
# On nettoye la colonne 'Company name' en supprimant les espaces en double
...
# On nettoye la colonne 'Type' en supprimant les informations de contrat et les espaces en double
...
# On nettoye la colonne 'Location' en supprimant les informations de région et les espaces en double
...
# On nettoye la colonne 'Job Description' en supprimant les balises HTML
df['Job Description'] = df['Job Description'].apply(lambda x: re.sub('<.*?>', '', str(x)))

# On enregistre les données nettoyées dans un nouveau fichier CSV
